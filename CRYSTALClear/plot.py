...
def plot_cry_EOS(eos, formula_unit=0, plot='VvsE', color='tab:blue', figsize=(5, 5), dpi=72, marker='o', fontsize=12, legend=None):
    """
    This function provides a tool to plot quantities extracted from the EOS module

    Args:
        eos[]: CRYSTAL object containing quantities extracted from the EOS module generated by the get_EOS() function
        formula_unit[]:
        plot[]:
        color[]:
        figsize[]:
